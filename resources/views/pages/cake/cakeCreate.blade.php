...
<div class="modal fade" id="createNewCake" tabindex="-1" role="dialog" aria-labelledby="createNewCake"
    aria-hidden="true">
                ...
                <form action="{{ route('cakes.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <input id="name" type="text"
                            ...
                            value="{{ old('name') }}" required autocomplete="name" placeholder="Input Cake Name">
                        @error('name')
