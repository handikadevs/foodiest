                ...
                <form action="{{ route('cakes.update', $cake->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <input id="thumbnail" class="form-control form-pill" type="file" placeholder="Input thumbnail "
                            value="{{ $cake->thumbnail }}" aria-describedby="thumbnail" name="thumbnail" disabled>
                    </div>
                    <div class="form-group mb-4">
                        <label for="name">Name</label>
                        <input id="name" class="form-control form-pill" type="text" placeholder="Input Name"
                            value="{{ old('name', $cake->name) }}" aria-describedby="name" name="name">
                    </div>
                    <div class="form-group">
                        <label for="description">Description</label>
                        <input id="description" class="form-control form-pill" type="text"
                            placeholder="Input description " value="{{ old('description', $cake->description) }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="ingredient" class="form-control" type="text" placeholder="Input ingredient"
                            aria-describedby="ingredient" name="ingredient">{{ old('ingredient', $cake->ingredient) }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="step">Steps</label>
                        <textarea id="step" class="form-control" type="text" placeholder="Input step " aria-describedby="step"
                            name="step">{{ old('step', $cake->step) }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="created_at">Created date</label>
                        <input id="created_at" class="form-control form-pill" type="text" disabled
                            value="{{ old('created_at', $cake->created_at) }}" aria-describedby="created_at">
                    </div>
                    <div class="form-group">
                        <label for="updated_at">Updated date</label>
                        <input id="updated_at" class="form-control form-pill" type="text" disabled
                            value="{{ old('updated_at', $cake->updated_at) }}" aria-describedby="updated_at">
                    </div>
                    <div class="card-footer">
                        <a type="button" class="btn btn-text" href="{{ route('cakes.index') }}">Cancel</a>
