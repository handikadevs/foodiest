...
<div class="modal fade" id="createNewDrink" tabindex="-1" role="dialog" aria-labelledby="createNewDrinkJuice"
    aria-hidden="true">
                ...
                <form action="{{ route('drink.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" id="category"
                            class="form-control form-pill @error('category') is-invalid @enderror" required
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="ingredient" type="text" class="form-control @error('ingredient') is-invalid @enderror"
                            name="ingredient" value="{{ old('ingredient') }}" required autocomplete="ingredient"
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="step" type="text" class="form-control @error('step') is-invalid @enderror" name="step"
