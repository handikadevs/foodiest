    ...
    <div class="u-body">
        ...
        <div class="card mb-4">
            <header class="card-header d-flex align-items-center">
                <h2 class="h3 card-header-title">Western</h2>
                <ul class="list-inline ml-auto mb-0">
                    <li class="list-inline-item mr-3">
                        <a class="btn btn-primary" data-toggle="modal" href="#createNewWestern">Create New Recipe</a>
                    </li>
                </ul>
            </header>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($data as $western)
                                <tr>
                                    <td>
                                        <img class="u-avatar--xs img-fluid rounded-circle mr-2"
                                            src="{{ asset('storage/food/thumbnail/' . $western->thumbnail) }}"
                                            alt="Food Thumbnail">
                                    </td>
                                    <td>{{ $western->name }}</td>
                                    <td>{{ $western->description }}</td>
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                <li>
                                                    <a class="d-flex align-items-center link-muted py-2 px-3"
                                                        href="{{ route('food.edit', $western->id) }}">
                                                        <i class="fa fa-edit mr-2"></i> Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <form method="POST" action="{{ route('food.destroy', $western->id) }}">
                                                        @csrf
