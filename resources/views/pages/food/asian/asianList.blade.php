    ...
    <div class="u-body">
        ...
        <div class="card mb-4">
            <header class="card-header d-flex align-items-center">
                <h2 class="h3 card-header-title">Asian</h2>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($data as $asian)
                                <tr>
                                    <td>
                                        <img class="u-avatar--xs img-fluid rounded-circle mr-2"
                                            src="{{ asset('storage/food/thumbnail/' . $asian->thumbnail) }}"
                                            alt="Food Thumbnail">
                                    </td>
                                    <td>{{ $asian->name }}</td>
                                    <td>{{ $asian->description }}</td>
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                <li>
                                                    <a class="d-flex align-items-center link-muted py-2 px-3"
                                                        href="{{ route('food.edit', $asian->id) }}">
                                                        <i class="fa fa-edit mr-2"></i> Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <form method="POST" action="{{ route('food.destroy', $asian->id) }}">
                                                        @csrf
